 ...
 *
 * Every query/mutation references keys from here — never hardcode a key array
...
export const queryKeys = {
  ...
  admin: {
    ...
    categoryProducts: (id: string, filters?: Filters) => ["admin", "category", id, "products", filters ?? {}] as const,
    collections: ["admin", "collections"] as const,
    collectionsList: (filters?: Filters) => ["admin", "collections", "list", filters ?? {}] as const,
    collection: (id: string) => ["admin", "collection", id] as const,
    collectionProducts: (id: string, filters?: Filters) => ["admin", "collection", id, "products", filters ?? {}] as const,
