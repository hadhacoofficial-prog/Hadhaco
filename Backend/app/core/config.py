...
class Settings(BaseSettings):
    ...
    # (Razorpay order created). Reset to the same 5 minutes as the cart-hold
    ...
    # 5 minutes, including during payment. See inventory domain plan §2.1a.
    RESERVATION_CHECKOUT_GRACE_MINUTES: int = 5
