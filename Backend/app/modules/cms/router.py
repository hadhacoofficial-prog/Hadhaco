...
@router.patch("/admin/media/{media_id}", response_model=BaseSuccessResponse[CmsMediaOut])
...
@router.get("/admin/publish-log", response_model=BaseSuccessResponse[list[PublishLogOut]])
