...
class Coupon(Base):
    ...
    coupon_type: Mapped[str] = mapped_column(String(20), nullable=False, server_default="percentage")
    value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
    min_order_amount: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, server_default="0")
    ...
    __table_args__ = (
        ...
        CheckConstraint("coupon_type IN ('percentage','fixed_amount','free_shipping')", name="coupons_type_check"),
    )
