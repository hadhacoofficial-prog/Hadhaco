...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms of Service · Hadha" }] }),
  component: Page,
});
...
function Page() {
  ...
  const state = config?.state || "Andhra Pradesh";

  const sections = [
    {
      t: "Acceptance of terms",
      b: `By accessing or using ${companyName}'s website and services you agree to be bound by these Terms of Service. If you do not agree, please discontinue use of our website.`,
    },
    {
      t: "Products & pricing",
    ...
    {
      t: "Orders & payment",
      b: `Placing an order constitutes an offer to purchase, which ${companyName} may accept or decline at its discretion. Payment must be successfully completed for the order to be confirmed.`,
    },
    {
      t: "Shipping & risk",
    ...
    },
    {
      ...
      b: `All content on this website — including images, design, text and trademarks — is the property of ${companyName} and is protected by applicable IP laws. Unauthorised use is prohibited.`,
    },
    {
      t: "Limitation of liability",
      b: `To the extent permitted by law, ${companyName}'s liability for any claim is limited to the value of the order in question. We are not liable for indirect or consequential losses.`,
    },
    {
      t: "Governing law",
      b: `These terms are governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of the courts at ${city}, ${state}.`,
    },
  ];
